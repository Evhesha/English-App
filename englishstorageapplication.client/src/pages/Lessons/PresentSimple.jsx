...
<p>Чтобы составить отрицательное предложение — нужно поставить вспомогательный глагол между подлежащим и глаголом.</p>
<div className="formula-container">
...
<p>При составлении вопросительных предложений вспомогательный глагол ставится перед подлежащим и последующим глаголом. Обычно — в начало предложения.</p>
...
<div className="important-box">
    <p><b>Важно!</b> Когда в предложении появляется вспомогательный глагол — у основного глагола пропадает окончание -s.</p>
</div>

<h3>Специальные вопросы</h3>
<p>При использовании вопросительных слов (why, where, how, when и т.д.), они ставятся в начало предложения:</p>
...
<p>Глагол to be (быть) всегда является особенным и его употребление во времени Present Simple зависит от подлежащего. Он имеет 3 разных формы:</p>

<div className="formula-container">
    <p><b>am</b> (для 1-го лица единственного числа: I)</p>
    <p><b>is</b> (для 3-го лица единственного числа: she / he / it)</p>
    <p><b>are</b> (для 1-го, 2-го и 3-го лица множественного числа: we / you / they)</p>
</div>

<div className="examples-box">
    <p><b>Примеры:</b></p>
    <p>I <b>am</b> ready — Я готов</p>
    <p>She <b>is</b> ready — Она готова</p>
    <p>We <b>are</b> ready — Мы готовы</p>
</div>
...
<p>Для того, чтобы лучше сориентироваться где и когда употребляются глаголы Present Simple — обратите внимание на особые маркеры в тексте.</p>
<p>Такими «маячками» для Present Simple являются наречия (often, always, usually, etc.) и указатели времени (every day, in the morning, on Fridays, etc.).</p>
...
<div className="time-markers">
    ...
    <div className="marker-group">
        ...
        <ul>
            ...
            <li>on Mondays/Tuesdays etc. - по понедельникам/вторникам и т.д.</li>
...
<div className="examples-box">
    <p><b>Примеры:</b></p>
    <p>She <b>always</b> drinks coffee in the morning — Она всегда пьет кофе по утрам</p>
    <p>I <b>usually</b> wake up at 6 am — Обычно я просыпаюсь в 6 утра</p>
    <p>They <b>often</b> talk about sport — Они часто говорят о спорте</p>
    <p>I check my smartphone <b>every 15 minutes</b> — Я проверяю свой телефон каждые 15 минут</p>
    <p>He takes a shower <b>twice a day</b> — Он принимает душ два раза в день</p>
    <p><b>On Mondays</b> we go to the central park — По понедельникам мы ходим в центральный парк</p>
    <p>He comes here <b>sometimes</b> — Иногда он приходит сюда</p>
</div>
