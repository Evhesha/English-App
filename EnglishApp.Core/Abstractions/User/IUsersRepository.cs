...
public interface IUsersRepository
{
    ...
    Task<EnglishStorageApplication.EnglishApp.Core.Models.User?> GetUserByEmailAsync(string email,
        CancellationToken cancellationToken);
    Task<Guid> CreateUserAsync(EnglishStorageApplication.EnglishApp.Core.Models.User user, 
        CancellationToken cancellationToken);

    Task<Guid> UpdateUserRoleAsync(EnglishStorageApplication.EnglishApp.Core.Models.User user,
        CancellationToken cancellationToken);
    Task<Guid> UpdateUserAsync(EnglishStorageApplication.EnglishApp.Core.Models.User user,
        CancellationToken cancellationToken);
